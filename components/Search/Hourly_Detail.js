...
export default function details({currentWeather, unitsSystem}) {
    const {feels_like, humidity, pressure, wind_speed} = currentWeather
        ...
        <View style = {styles.Row}>
            <View style = {{ ...styles.Box, justifyContent: 'center'}}>
              <View style = {styles.Row1}>
                ...
                {unitsSystem == 'metric'? (<Text style = {styles.textSecondary}>{feels_like}° C</Text>) : unitsSystem == 'imperial'? (<Text style = {styles.textSecondary}>{feels_like}° F</Text>) : (<Text style = {styles.textSecondary}>{feels_like}° K</Text>)}
                </View>
              </View>
            </View>
            <View style = {{ ...styles.Box, justifyContent: 'center'}}>
